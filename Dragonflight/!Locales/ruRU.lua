...
L = BigWigs:NewBossLocale("Dawn of the Infinite Trash", "ruRU")
if L then
	------ Galakrond's Fall ------
...
L = BigWigs:NewBossLocale("Ruby Life Pools Trash", "ruRU")
if L then
	L.primal_juggernaut = "Изначальный исполин"
	L.flashfrost_earthshaper = "Демиург Морозной Вспышки"
	L.flashfrost_chillweaver = "Ткач Холода Морозной Вспышки"
	L.defier_draghar = "Драгхар Отрицатель"
	L.primalist_flamedancer = "Воин стихий – танцор пламени"
	L.blazebound_destroyer = "Пламенный разрушитель"
	L.primalist_shockcaster = "Воин стихий – искромаг"
	L.thunderhead = "Громоголов"
	L.flamegullet = "Огнезев"
	L.tempest_channeler = "Чаротворица бури"
	L.flame_channeler = "Чаротворец пламени"
	L.high_channeler_ryvati = "Верховная чаротворица Ривати"

	--L.kyrakka_and_erkhart_warmup_trigger = "Your false queen cannot stop us. We are the truth."
end

L = BigWigs:NewBossLocale("Kyrakka and Erkhart Stormvein", "ruRU")
if L then
	L.winds = "Ветра"
end
...
L = BigWigs:NewBossLocale("The Nokhud Offensive Trash", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Uldaman: Legacy of Tyr Trash", "ruRU")
if L then
