...
L = BigWigs:NewBossLocale("Dawn of the Infinite Trash", "ptBR")
if L then
	------ Galakrond's Fall ------
...
if L then
	...
	L.primalist_geomancer = "Geomante Primevista"
	L.containment_apparatus = "Aparato de Contenção"
	...
	L.primalist_galesinger = "Vendaval Uivante Primevista"
	L.primalist_icecaller = "Chamagelo Primevista"
	L.gusting_protodragon = "Protodragão Lufante"
	L.glacial_protodragon = "Protodragão Glacial"
	L.subterranean_protodragon = "Protodragão Subterrâneo"
	L.aqua_rager = "Furiante Aquático"
	L.infuser_sariya = "Infusora Sariya"
end
...
if L then
	...
	L.qalashi_blacksmith = "Ferreiro Qalashi"
	L.forgewrought_monstrosity = "Monstruosidade Forjaforjada"
	L.qalashi_plunderer = "Saqueador Qalashi"
	L.qalashi_thaumaturge = "Taumaturga Qalashi"
	L.apex_blazewing = "Chaminasa Alfa"
...
L = BigWigs:NewBossLocale("Ruby Life Pools Trash", "ptBR")
if L then
...
if L then
	...
	L.scalebane_lieutenant = "Tenente Escamorte"
	L.drakonid_breaker = "Quebradora Draconídea"
end

-- The Nokhud Offensive

L = BigWigs:NewBossLocale("The Nokhud Offensive Trash", "ptBR")
if L then
	...
	L.primalist_thunderbeast = "Fera-do-trovão Primevista"
	L.desecrated_ohuna = "Ohuna Profanada"
	L.ukhel_deathspeaker = "Morta-voz Ukhel"
	L.risen_mystic = "Mística Reanimada"
	L.ukhel_beastcaller = "Chama-feras Ukhel"
	L.soulharvester_galtmaa = "Ceifalmas Galtmaa"
	L.nokhud_defender = "Defensor Nokhid"
	L.nokhud_thunderfist = "Punho de Trovão Nokhid"
	L.balara = "Balara"
	L.batak = "Batak"
end
...
L = BigWigs:NewBossLocale("Uldaman: Legacy of Tyr Trash", "ptBR")
if L then
