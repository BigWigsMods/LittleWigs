...
if L then
	...
	L.spellbound_scepter = "주문결속 홀"
	L.arcane_ravager = "비전 약탈자"
	L.unruly_textbook = "광란의 교과서"
	L.guardian_sentry = "수호의 감시자"
	L.alpha_eagle = "독수리 우두머리"
	L.vile_lasher = "부정한 덩굴손"
	L.algethar_echoknight = "알게타르 메아리 기사"
	L.spectral_invoker = "유령 기원사"
	L.ethereal_restorer = "실체 없는 구원자"
end
...
L = BigWigs:NewBossLocale("Dawn of the Infinite Trash", "koKR")
if L then
	------ Galakrond's Fall ------
	L.infinite_chronoweaver = "무한의 시간술사"
	L.infinite_timeslicer = "무한의 시간절단자"
	L.epoch_ripper = "시대의 해체자"
	L.coalesced_time = "응축된 시간"
	L.interval = "간격"
	L.timestream_leech = "시간의 흐름 거머리"
	...
	L.timelost_aerobot = "잃어버린 시간의 비행로봇"
	L.chronaxie = "크로나시"
	L.horde_destroyer = "호드 구축함"
	L.alliance_destroyer = "얼라이언스 구축함"
	L.horde_farseer = "호드 선견자"
	L.paladin_of_the_silver_hand = "은빛 성기사단의 성기사"
...
if L then
	...
	L.primalist_galesinger = "원시술사 강풍노래꾼"
	L.primalist_icecaller = "원시술사 얼음소환사"
	L.gusting_protodragon = "몰아치는 원시용"
	L.glacial_protodragon = "빙하의 원시용"
	L.subterranean_protodragon = "지하의 원시용"
	L.aqua_rager = "물의 원령"
	L.infuser_sariya = "주입자 사리야"
end
...
L = BigWigs:NewBossLocale("Ruby Life Pools Trash", "koKR")
if L then
	...
	L.blazebound_destroyer = "화염결속 파괴자"
	L.primalist_shockcaster = "원시술사 충격술사"
...
if L then
	...
	L.arcane_tender = "비전지기"
	L.arcane_elemental = "비전의 정령"
	L.unstable_curator = "불안정한 관리인"
	L.rune_seal_keeper = "룬 봉인 수호자"
	L.crystal_fury = "수정의 격노"
	L.crystal_thrasher = "수정 투사"
	L.arcane_construct = "비전 피조물"
	L.scalebane_lieutenant = "비늘파멸 부관"
...
if L then
	...
	L.primalist_thunderbeast = "원시술사 천둥야수"
	L.desecrated_ohuna = "더럽혀진 오후나"
	L.ukhel_deathspeaker = "우켈 죽음예언자"
	L.risen_mystic = "되살아난 비술사"
	L.ukhel_beastcaller = "우켈 야수소환사"
...
L = BigWigs:NewBossLocale("Uldaman: Legacy of Tyr Trash", "koKR")
if L then
