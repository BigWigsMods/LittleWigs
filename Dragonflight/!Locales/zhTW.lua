...
L = BigWigs:NewBossLocale("Dawn of the Infinite Trash", "zhTW")
if L then
	------ Galakrond's Fall ------
	L.infinite_chronoweaver = "恆龍時空編織者"
	L.infinite_timeslicer = "恆龍斬時者"
	L.epoch_ripper = "時光撕裂者"
	L.coalesced_time = "聚合時間"
	--L.interval = "Interval"
	L.timestream_leech = "時間流吸血者"
	...
	L.timelost_waveshaper = "時佚塑浪者"
	L.timelost_aerobot = "時佚空中機器人"
	L.chronaxie = "克羅納希"
	...
	L.rift_stability_desc = "當時間裂隙開啟時顯示提醒。"
...
L = BigWigs:NewBossLocale("Ruby Life Pools Trash", "zhTW")
if L then
	L.primal_juggernaut = "原始重戰士"
	L.flashfrost_earthshaper = "閃霜塑地者"
	L.flashfrost_chillweaver = "閃霜織寒者"
	L.defier_draghar = "挑戰者德拉哈"
	L.primalist_flamedancer = "洪荒使者舞焰者"
	L.blazebound_destroyer = "火縛毀滅者"
	L.primalist_shockcaster = "洪荒使者地震法師"
	L.thunderhead = "雷首蜥蜴"
	L.flamegullet = "火喉"
	L.tempest_channeler = "暴風導魔師"
	L.flame_channeler = "烈焰傳導者"
	--L.high_channeler_ryvati = "High Channeler Ryvati"

	L.kyrakka_and_erkhart_warmup_trigger = "那個假龍后阻止不了我們，因為我們才是真理。"
end
...
L = BigWigs:NewBossLocale("The Nokhud Offensive Trash", "zhTW")
if L then
	--L.teera_and_maruuk_warmup_trigger = "Why has our rest been disturbed?"

	L.nokhud_plainstomper = "諾庫德平原踐踏者"
	L.nokhud_hornsounder = "諾庫德號角手"
	--L.nokhud_beastmaster = "Nokhud Beastmaster"
	--L.nokhud_longbow = "Nokhud Longbow"
	L.primal_stormshield = "洪荒風暴盾衛"
	...
	L.soulharvester_galtmaa = "靈魂收割者加爾特瑪"
	L.nokhud_defender = "諾庫德防衛者"
	L.nokhud_thunderfist = "諾庫德雷拳者"
	--L.balara = "Balara"
	--L.batak = "Batak"
end
...
L = BigWigs:NewBossLocale("Uldaman: Legacy of Tyr Trash", "zhTW")
if L then
