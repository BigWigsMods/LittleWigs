...
BigWigsAPI.SetBossModuleLocale("Den of Nalorakk Trash", {
	offerings_acquired = "획득한 제물",
	offerings_acquired_desc = "제물이 획득되었을 때 알림을 표시합니다.",
})

-- Maisara Caverns

BigWigsAPI.SetBossModuleLocale("Maisara Caverns Trash", {
	prisoners_freed = "포로 해방",
	prisoners_freed_desc = "포로가 해방되었을 때 알림을 표시합니다.",
	custom_on_cooking_pot_autotalk_desc = "NPC 대화에서 '든든한 썩은가지 스튜' 버프를 부여하는 항목을 자동으로 선택합니다.\n\n|T4659336:16|t든든한 썩은가지 스튜\n{1269056}",
	custom_on_ritual_cauldron_autotalk_desc = "NPC 대화에서 '의식 혼합물' 버프를 부여하는 항목을 자동으로 선택합니다.\n\n|T236271:16|t의식 혼합물\n{1271300}",

	cooking_pot = "요리 냄비",
	ritual_cauldron = "의식용 가마솥",
})

-- Murder Row

BigWigsAPI.SetBossModuleLocale("Murder Row Trash", {
	snitches_interrogated = "끄나풀 심문",
	snitches_interrogated_desc = "끄나풀이 심문되었을 때 알림을 표시합니다.",
})

-- Nexus-Point Xenas

BigWigsAPI.SetBossModuleLocale("Nexus-Point Xenas Trash", {
	custom_on_arcane_tripwire_autotalk_desc = "|cFFFF0000한밤 기계공학 25 필요.|r NPC 대화에서 비전 철사덫을 비활성화하는 옵션을 자동으로 선택합니다.",
})
