...
if L then
	...
	L.trash_channel = "Canalizzazione"
	L.trash_channel_desc = "Avvisa quando un mob trash canalizza un incantesimo."
	L.customization = "Personalizzazione"
	L.all_units = "Tutte le unità mostrano messaggi e riproducono suoni"
	L.messages_all_sounds_target = "Tutte le unità mostrano messaggi, ma solo il tuo bersaglio riproduce suoni"
