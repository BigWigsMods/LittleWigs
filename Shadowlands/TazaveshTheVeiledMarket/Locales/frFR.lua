...
if L then
	...
	L.menagerie_warmup_trigger2 = "Des bêtes enragées vous pourrissent la vie ? Nous avons la solution !"
	L.menagerie_warmup_trigger3 = "C’est maintenant ou jamais ! La hache est à moi !"
