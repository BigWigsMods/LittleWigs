...
L = BigWigs:NewBossLocale("Torque Clankfire and Sprok (Kriegval's Rest)", "esMX")
if L then
	L.bossName = "Torque Pirolatón y Sprok"
	L.torque_clankfire = "Torque Pirolatón"
	L.sprok = "Sprok"
end
...
L = BigWigs:NewBossLocale("Reformed Fury", "esMX")
if L then
