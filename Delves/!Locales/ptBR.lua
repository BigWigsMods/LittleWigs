if GetLocale() ~= "ptBR" then return end -- XXX remove in 11.2, to be replaced with AllowLoadTextLocale
...
L = BigWigs:NewBossLocale("Nexus-Princess Ky'veza (Tier 8)", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Underpin Rares", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Overcharged Trash", "ptBR")
if L then
