if GetLocale() ~= "esES" then return end -- XXX remove in 11.2, to be replaced with AllowLoadTextLocale
...
L = BigWigs:NewBossLocale("Nexus-Princess Ky'veza (Tier 8)", "esES")
if L then
...
L = BigWigs:NewBossLocale("Overcharged Trash", "esES")
if L then
