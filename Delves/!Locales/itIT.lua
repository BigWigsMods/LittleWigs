if GetLocale() ~= "itIT" then return end -- XXX remove in 11.2, to be replaced with AllowLoadTextLocale
...
L = BigWigs:NewBossLocale("Nexus-Princess Ky'veza (Tier 8)", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Underpin Rares", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Overcharged Trash", "itIT")
if L then
