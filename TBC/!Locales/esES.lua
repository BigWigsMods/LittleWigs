...
local L = BigWigs:NewBossLocale("Vexallus", "esES")
if not L then return end
if L then
	--L.energy_discharged = "%s discharged" -- %s = Pure Energy (npc ID = 24745)
end

L = BigWigs:NewBossLocale("Kael'thas Sunstrider Magisters' Terrace", "esES")
if L then
...
L = BigWigs:NewBossLocale("Magisters' Terrace Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("Mana-Tombs Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("Old Hillsbrad Foothills Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("Lieutenant Drake", "esES")
if L then
...
L = BigWigs:NewBossLocale("Captain Skarloc", "esES")
if L then
...
L = BigWigs:NewBossLocale("Epoch Hunter", "esES")
if L then
...
L = BigWigs:NewBossLocale("Harbinger Skyriss", "esES")
if L then
...
L = BigWigs:NewBossLocale("The Arcatraz Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("The Black Morass Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("Pathaleon the Calculator", "esES")
if L then
	--L.despawn_message = "Nether Wraiths Despawning Soon"
end

L = BigWigs:NewBossLocale("Gatewatcher Iron-Hand", "esES")
if L then
	L.bossName = "Vigía de las puertas Manoyerro"
end

L = BigWigs:NewBossLocale("Gatewatcher Gyro-Kill", "esES")
if L then
	L.bossName = "Vigía de las puertas Giromata"
end

L = BigWigs:NewBossLocale("Nethermancer Sepethrea", "esES")
if L then
...
L = BigWigs:NewBossLocale("The Shattered Halls Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("The Slave Pens Trash", "esES")
if L then
...
L = BigWigs:NewBossLocale("Ahune", "esES")
if L then
	L.ahune = "Ahune"
...
L = BigWigs:NewBossLocale("Mekgineer Steamrigger", "esES")
if L then
