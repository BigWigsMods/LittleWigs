local L = BigWigs:NewBossLocale("Exarch Maladaar", "esES") or BigWigs:NewBossLocale("Exarch Maladaar", "esMX")
...
L = BigWigs:NewBossLocale("Shirrak the Dead Watcher", "esES") or BigWigs:NewBossLocale("Shirrak the Dead Watcher", "esMX")
if L then
	--L.focus = "Focus Fire"
