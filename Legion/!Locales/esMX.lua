...
BigWigsAPI.SetBossModuleLocale("Court of Stars Trash", {
	...
	spyFoundPattern = "Calma, no nos apuremos", -- Calma, no nos apuremos, [playername]. Mejor sígueme y hablemos de esto en un lugar algo más privado…
...
BigWigsAPI.SetBossModuleLocale("Karazhan Trash", {
	...
	opera_hall_westfall_story_text = "Sala de la Ópera: Páramos de Poniente",
	--opera_hall_westfall_story_trigger = "we meet two lovers", -- Tonight... we meet two lovers born on opposite sides of Sentinel Hill.
	opera_hall_beautiful_beast_story_text = "Sala de la Ópera: bestia hermosa",
