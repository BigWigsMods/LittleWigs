...
if L then
	...
	L.lura_warmup_trigger = "Cuánto caos y cuánto tormento... Jamás había sentido algo parecido."
	L.lura_warmup_trigger_2 = "Pero esas reflexiones pueden esperar. Esta entidad debe morir."
