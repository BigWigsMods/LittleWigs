...
if L then
	...
	L.opera_hall_beautiful_beast_story_trigger = "Эта история о любви и гневе навсегда поставит точку в вопросе, обманчива ли красота." -- Tonight... a tale of romance and rage, one which will prove once and for all if beaty is more than skin deep.
