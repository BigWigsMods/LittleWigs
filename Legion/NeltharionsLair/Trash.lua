...
local L = mod:SetDefaultLocale({
	...
	vileshard_crawler = "Vileshard Crawler",
	tarspitter_lurker = "Tarspitter Lurker",
	rockback_gnasher = "Rockback Gnasher",
	vileshard_hulk = "Vileshard Hulk",
	vileshard_chunk = "Vileshard Chunk",
	understone_drummer = "Understone Drummer",
	mightstone_breaker = "Mightstone Breaker",
	blightshard_shaper = "Blightshard Shaper",
	stoneclaw_grubmaster = "Stoneclaw Grubmaster",
	tarspitter_grub = "Tarspitter Grub",
	rotdrool_grabber = "Rotdrool Grabber",
	understone_demolisher = "Understone Demolisher",
	rockbound_trapper = "Rockbound Trapper",
	emberhusk_dominator = "Emberhusk Dominator",
})
