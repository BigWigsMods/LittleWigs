...
local L = BigWigs:NewBossLocale("Ara-Kara, City of Echoes Trash", "ruRU")
if L then
	L.discordant_attendant = "Диссонирующий служитель"
	L.engorged_crawler = "Разъевшийся ползун"
	L.trilling_attendant = "Служитель-щелкун"
	L.ixin = "Иксин"
	L.nakt = "Накт"
	L.atik = "Атик"
...
L = BigWigs:NewBossLocale("Anub'zekt", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Cinderbrew Meadery Trash", "ruRU")
if L then
	--L.venture_co_pyromaniac = "Venture Co. Pyromaniac"
	L.venture_co_patron = "Посетитель из Торговой компании"
	...
	L.brew_drop = "Хмельной выброс"
	L.taste_tester = "Дегустатор"
...
L = BigWigs:NewBossLocale("Brew Master Aldryr", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("City of Threads Trash", "ruRU")
if L then
	...
	L.pale_priest = "Бледная жрица"
	L.eye_of_the_queen = "Око королевы"
	L.covert_webmancer = "Скрытый тенетомант"
	L.web_marauder = "Паутинный мародер"
	L.royal_venomshell = "Королевский бронеяд"
	L.unstable_test_subject = "Нестабильный подопытный объект"
	L.sureki_unnaturaler = "Суреки-неестественник"
	L.elder_shadeweaver = "Старейший заклинатель теней"
	L.hulking_warshell = "Бронированный боец – гигант"
...
L = BigWigs:NewBossLocale("Fangs of the Queen", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Darkflame Cleft Trash", "ruRU")
if L then
	L.rank_overseer = "Военный надзиратель"
	L.lowly_moleherd = "Кротопас-плебей"
	L.royal_wicklighter = "Королевский зажигатель"
	L.kobold_taskworker = "Кобольд-служитель"
	L.wandering_candle = "Блуждающая свеча"
	L.blazing_fiend = "Пылающий монст"
	L.sootsnout = "Сажеморд"
	L.torchsnarl = "Пламескал"
	L.skittering_darkness = "Снующая тьма"
	L.shuffling_horror = "Слоняющийся ужас"
	L.corridor_creeper = "Коридорный ужас"
	L.creaky_mine_cart = "Скрипучая вагонетка"
...
L = BigWigs:NewBossLocale("Ol' Waxbeard", "ruRU")
if L then
	--L.dynamite_mine_cart = "Dynamite Mine Cart"
end

L = BigWigs:NewBossLocale("The Darkness", "ruRU")
if L then
	L.wriggling_darkspawn = "Извивающееся порождение Тьмы"
end

-- Eco-Dome Al'dani

L = BigWigs:NewBossLocale("Eco-Dome Al'dani Trash", "ruRU")
if L then
	...
	L.evoked_spirit = "Призванный дух"
...
L = BigWigs:NewBossLocale("Operation: Floodgate Trash", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Priory of the Sacred Flame Trash", "ruRU")
if L then
	...
	L.fervent_sharpshooter = "Яростный снайпер"
	L.war_lynx = "Боевая рысь"
...
L = BigWigs:NewBossLocale("Baron Braunpyke", "ruRU")
if L then
	--L.charges = "%d charges"
end
...
L = BigWigs:NewBossLocale("Awakening the Machine", "ruRU")
if L then
	L.awakening_the_machine = "Пробуждение Машины"
...
L = BigWigs:NewBossLocale("Brawler's Guild", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("The Dawnbreaker Trash", "ruRU")
if L then
	--L.arathi_lamplighter = "Arathi Lamplighter"
	L.nightfall_curseblade = "Сумеречный проклятый клинок"
	...
	L.nightfall_shadowalker = "Сумеречный странник теней"
...
L = BigWigs:NewBossLocale("The Rookery Trash", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("The Stonevault Trash", "ruRU")
if L then
	L.earth_infused_golem = "Насыщенный землей голем"
	L.repurposed_loaderbot = "Переделанный бот-погрузчик"
	L.ghastly_voidsoul = "Жуткая душа из Бездны"
	L.cursedheart_invader = "Проклятый завоеватель"
	L.void_bound_despoiler = "Зачарованный Бездной расхититель"
	L.void_bound_howler = "Подчиненный Бездной завыватель"
	L.turned_speaker = "Обращенный глашатай"
	L.void_touched_elemental = "Меченный Бездной элементаль"
	L.forgebound_mender = "Кованая целительница"
	L.forge_loader = "Кузнечный погрузчик"
	L.cursedforge_honor_guard = "Отважный страж проклятой кузни"
	L.cursedforge_stoneshaper = "Заклинатель проклятой кузни"
	L.rock_smasher = "Камнекрушитель"
