...
if L then
	...
	L.trilling_attendant = "Attendente Trillante"
	L.ixin = "Ixin"
	L.nakt = "Nakt"
	L.atik = "Atik"
	...
	L.reinforced_drone = "Fuco Rinforzato"
...
L = BigWigs:NewBossLocale("Cinderbrew Meadery Trash", "itIT")
if L then
	--L.venture_co_pyromaniac = "Venture Co. Pyromaniac"
	L.venture_co_patron = "Cliente della S.P.R. & Co"
	...
	L.brew_drop = "Goccia di Idromele"
	L.taste_tester = "Assaggiatore"
...
L = BigWigs:NewBossLocale("Brew Master Aldryr", "itIT")
if L then
...
L = BigWigs:NewBossLocale("City of Threads Trash", "itIT")
if L then
	...
	L.pale_priest = "Sacerdotessa Pallida"
	L.eye_of_the_queen = "Occhio della Regina"
	L.covert_webmancer = "Telamante Celata"
	L.web_marauder = "Predone delle Ragnatele"
	L.royal_venomshell = "Gusciotossico Reale"
	L.unstable_test_subject = "Cavia Instabile"
	L.sureki_unnaturaler = "Denaturalizzatore Sureki"
	L.elder_shadeweaver = "Tessiombre Anziano"
	L.hulking_warshell = "Guscio da Guerra Gigantesco"
...
L = BigWigs:NewBossLocale("Fangs of the Queen", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Darkflame Cleft Trash", "itIT")
if L then
	L.rank_overseer = "Sovrintendente di Rango"
	L.lowly_moleherd = "Cacciatalpe Misero"
	L.royal_wicklighter = "Attizzamicce Reale"
	L.kobold_taskworker = "Svolgimansioni Coboldo"
	L.wandering_candle = "Candela Errante"
	L.blazing_fiend = "Demonio Fiammeggiante"
	L.sootsnout = "Fuliggimuso"
	L.torchsnarl = "Ringhiostorto"
	L.skittering_darkness = "Oscurità Brulicante"
	L.shuffling_horror = "Orrore Barcollante"
	L.corridor_creeper = "Orrore dei Cunicoli"
	L.creaky_mine_cart = "Carrello Minerario Cigolante"
...
L = BigWigs:NewBossLocale("Ol' Waxbeard", "itIT")
if L then
	--L.dynamite_mine_cart = "Dynamite Mine Cart"
end

L = BigWigs:NewBossLocale("The Darkness", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Priory of the Sacred Flame Trash", "itIT")
if L then
	...
	L.fervent_sharpshooter = "Tiratrice Scelta Fervente"
	L.war_lynx = "Lince da Guerra"
...
L = BigWigs:NewBossLocale("Awakening the Machine", "itIT")
if L then
	L.awakening_the_machine = "Risveglio della Macchina"
...
L = BigWigs:NewBossLocale("Brawler's Guild", "itIT")
if L then
...
L = BigWigs:NewBossLocale("The Rookery Trash", "itIT")
if L then
...
L = BigWigs:NewBossLocale("The Stonevault Trash", "itIT")
if L then
	L.earth_infused_golem = "Golem Infuso della Terra"
	L.repurposed_loaderbot = "Caricabot Ricondizionato"
	L.ghastly_voidsoul = "Anima Vuota Spettrale"
	L.cursedheart_invader = "Invasore Cuorcorrotto"
	L.void_bound_despoiler = "Saccheggiatore Vincolato al Vuoto"
	L.void_bound_howler = "Urlatore Vincolato dal Vuoto"
	L.turned_speaker = "Oratore Convertito"
	L.void_touched_elemental = "Elementale Toccato dal Vuoto"
	L.forgebound_mender = "Guaritrice Vincolata alla Forgia"
	L.forge_loader = "Caricatore della Forgia"
	L.cursedforge_honor_guard = "Guardia d'Onore Malaforgia"
	L.cursedforge_stoneshaper = "Formapietre Malaforgia"
	L.rock_smasher = "Fracassatore di Rocce"
