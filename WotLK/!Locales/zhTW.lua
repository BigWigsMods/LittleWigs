...
L = BigWigs:NewBossLocale("Gal'darah", "zhTW")
if L then
	--L.forms = "Forms"
...
L = BigWigs:NewBossLocale("Halls of Lightning Trash", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("Tribunal of Ages", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("Pit of Saron Trash", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("The Culling of Stratholme Trash", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("The Nexus Trash", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("Xevozz", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("Trial of the Champion Trash", "zhTW")
if L then
...
L = BigWigs:NewBossLocale("Utgarde Pinnacle Trash", "zhTW")
if L then
