...
BigWigsAPI.SetBossModuleLocale("Ahn'kahet Trash", {
	spellflinger = "Sortílego Ahn'kahar",
	eye = "Olho de Taldaram",
	darkcaster = "Taumaturgo do Crepúsculo",
})
...
BigWigsAPI.SetBossModuleLocale("Gal'darah", {
	forms = "Formas",
	forms_desc = "Avisar antes de Gal'darah mudar de forma.",

	form_rhino = "Forma de Rinoceronte",
...
BigWigsAPI.SetBossModuleLocale("Halls of Lightning Trash", {
	runeshaper = "Traçarrunas Forjado em Tempestade",
	sentinel = "Sentinela Forjada em Tempestade",
})
