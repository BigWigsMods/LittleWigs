...
local L = BigWigs:NewBossLocale("Kanrethad Ebonlocke", "esMX")
...
L = BigWigs:NewBossLocale("Essence of Order", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Thalnos the Soulrender", "esMX")
if L then
	--L.engage_yell = "My endless agony shall be yours, as well!"
end

L = BigWigs:NewBossLocale("Brother Korloff", "esMX")
if L then
	--L.engage_yell = "I will break you."
end

L = BigWigs:NewBossLocale("High Inquisitor Whitemane", "esMX")
if L then
	--L.engage_yell = "My legend begins NOW!"
end

L = BigWigs:NewBossLocale("The Headless Horseman", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Lilian Voss", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Master Snowdrift", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Shado-Pan Monastery Trash", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Yan-Zhu the Uncasked", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Lorewalker Stonestep", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Temple of the Jade Serpent Trash", "esMX")
if L then
