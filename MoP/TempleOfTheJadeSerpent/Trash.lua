...
local L = mod:SetDefaultLocale({
	corrupt_living_water = "Corrupt Living Water",
	fallen_waterspeaker = "Fallen Waterspeaker",
	haunting_sha = "Haunting Sha",
	the_talking_fish = "The Talking Fish",
	the_songbird_queen = "The Songbird Queen",
	the_crybaby_hozen = "The Crybaby Hozen",
	the_nodding_tiger = "The Nodding Tiger",
	the_golden_beetle = "The Golden Beetle",
	sha_touched_guardian = "Sha-Touched Guardian",
	depraved_mistweaver = "Depraved Mistweaver",
	shambling_infester = "Shambling Infester",
	minion_of_doubt = "Minion of Doubt",
})
